    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty() | contraseña.length == 0) {
            ...
            try {
                ...
                if (resultado) {
                    gestionOperadores.verificarCorreoOperador(a, c);
                    res = gestionOperadores.consulta("select * from esquema.Operador");
                    while (res.next()) {
                    ...
                    gestionOperadores.verificarUsuarioOperador(a, c);
                    res = gestionOperadores.consulta("select * from esquema.Operador");
                    while (res.next()) {
